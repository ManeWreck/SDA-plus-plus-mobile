namespace Steam_Desktop_Authenticator
{
    partial class WelcomeForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.btnImportConfig.Text = "Импортировать существующую настройку SDA / SDA++\r\nиз другой папки на этом ПК.";
            ...
            this.label2.Text = "Выберите, как запустить ваш кастомный форк:";
