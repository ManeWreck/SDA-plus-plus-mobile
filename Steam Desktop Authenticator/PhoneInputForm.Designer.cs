namespace Steam_Desktop_Authenticator
{
    partial class PhoneInputForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.label1.Text = "Для добавления мобильного аутентификатора к аккаунту Steam нужен номер телефона.\r" +
    "\nЭтот номер должен уметь принимать SMS.\r\nVoIP и виртуальные номера не поддержива" +
    "ются.";
            // 
            // label2
            // 
            ...
            this.label2.Text = "Двухбуквенный код страны номера:";
            // 
            // label3
            // 
            ...
            this.label3.Text = "Номер телефона: (+1 0000000000)";
            // 
            // txtPhoneNumber
            // 
